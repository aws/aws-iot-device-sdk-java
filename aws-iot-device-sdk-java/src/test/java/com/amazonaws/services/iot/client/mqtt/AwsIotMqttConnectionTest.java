...
public class AwsIotMqttConnectionTest {
    ...
    public void testOpenConnection() throws AWSIotException, MqttSecurityException, MqttException {
        ...
        }).when(mqttClient).connect(any(MqttConnectOptions.class), any(Object.class), any(IMqttActionListener.class));

        connection.openConnection(null);

        verify(mqttClient).connect(any(MqttConnectOptions.class), any(Object.class), any(IMqttActionListener.class));
    ...
    public void testPublishMessage()
        ...
        }).when(mqttClient).publish(any(String.class), any(MqttMessage.class), any(Object.class),
                any(IMqttActionListener.class));

        connection.publishMessage(message);

        verify(mqttClient).publish(any(String.class), any(MqttMessage.class), any(Object.class),
                any(IMqttActionListener.class));
    ...
    public void testSubscribeTopic()
        ...
        verify(mqttClient).subscribe(any(String.class), anyInt(), any(Object.class), any(IMqttActionListener.class));
        assertEquals("test/topic", mqttTopic);
    ...
    public void testUnsubscribeTopic()
        ...
        }).when(mqttClient).unsubscribe(any(String.class), any(Object.class), any(IMqttActionListener.class));

        connection.unsubscribeTopic(message);

        verify(mqttClient).unsubscribe(any(String.class), any(Object.class), any(IMqttActionListener.class));
        assertEquals("test/topic", mqttTopic);
    }
